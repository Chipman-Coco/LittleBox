...
import com.chipman.common.adapter.SimpleDiffCallback
import com.chipman.common.adapter.SimpleDiffItemCallback
        ...
        SimpleDiffItemCallback(
            ...
            areContentSame = { oldItem: Any, newItem: Any ->
                when {
                    ...
                    oldItem is CollectBean && newItem is CollectBean -> oldItem == newItem && oldItem.isCollect == newItem.isCollect
